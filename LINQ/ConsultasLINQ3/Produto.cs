    ...
    public class Produto
    {
        ...
        public static List<Produto> GetProduto()
        {
            List<Produto> produtos = new List<Produto>()
            {
                ...
                new Produto { Nome = "Notebook", Categoria = "Eletrônicos", Preco = 3500.00m, Estoque = 15, Descricao = "Notebook com processador i7, 16GB RAM e SSD de 512GB." },
                ...
                new Produto { Nome = "Livro de Terror", Categoria = "Livros", Preco = 39.90m, Estoque = 30, Descricao = "Livro de terror best-seller, edição de capa dura." },
